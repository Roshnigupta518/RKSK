...
//     allCompleted = isMainFormFilled
//       ? true
//       : filledSubs.length === totalSubs;
...
//         {status !== "Scheduled" && !(activiyDetails.clockinTime && activiyDetails.clockoutTime && activiyDetails.activity_Id) && (
